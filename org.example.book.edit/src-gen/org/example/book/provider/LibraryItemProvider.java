/**
 */
package org.example.book.provider;
...
/**
 * This is the item provider adapter for a {@link org.example.book.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LibraryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BookPackage.Literals.LIBRARY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BookPackage.Literals.LIBRARY__BOOKS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Library.class)) {
			case BookPackage.LIBRARY__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case BookPackage.LIBRARY__BOOKS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BookPackage.Literals.LIBRARY__BOOKS,
				 BookFactory.eINSTANCE.createBook()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return BookEditPlugin.INSTANCE;
	}
